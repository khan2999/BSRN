...
if _name_ == "_main_":
    """
    @brief Hauptfunktion des Netzwerk-Startskripts.
    @details Lädt Konfigurationsdaten, richtet einen IPC-Listener ein und startet
             den Netzwerkdienst über die Funktion run_network_service().
    ...
    with Listener(address, authkey=b'ipc_secret') as listener:
        # @brief Erstellt IPC-Listener für Netzwerk-Kommandos von der UI
        ...
        # @brief Übergibt Steuerung an Netzwerkdienst nach Verbindungsaufbau
